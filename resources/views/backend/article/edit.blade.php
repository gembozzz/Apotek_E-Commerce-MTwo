    ...
    <div class="container-fluid">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-warning text-white">
                <h3 class="card-title"><i class="fas fa-edit me-2"></i> Edit Artikel</h3>
            </div>
            ...
            <form action="{{ route('article.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <textarea name="content" class="form-control @error('content') is-invalid @enderror" rows="6"
                        id="content"
                        placeholder="Isi artikel di sini...">{{ old('content', $article->content) }}</textarea>
                    @error('content')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('storage/' . $article->thumbnail) }}" alt="Thumbnail" class="mb-2"
